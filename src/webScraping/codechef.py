...
class UserData:
    ...
    def __codechef(self):
        ...
        full = problems_solved_get()
        details = {"status": 'Success', "rating": int(rating), "highest_rating": int(highest_rating),
                    "fully_solved": int(full)}
...
if __name__ == '__main__':
    ud = UserData(str(sys.argv[1]))
    ans = ud.get_details(str(sys.argv[2]))
